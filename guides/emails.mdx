...
Follow [this video](https://www.loom.com/share/284d2005aace4f2a8e8bbed9aad4af99) to see how to create a transactional email for this purpose
...
```ts src/app/api/webhooks/stripe.ts
 case "checkout.session.expired":
            // ❔🛒 User didn't complete the payment, useful for tracking abandoned carts
